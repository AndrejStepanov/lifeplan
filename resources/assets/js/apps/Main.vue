<template>
	<c-app :curentSystem="curentSystem" :panelLeftShow="true" :panelLeftDrawer="true" :panelRightShow="true" :panelRightDrawer="true" :panelsConfig="panelsConfig" :needMainPanels="true"  >
