...
window._vue = new window.Vue({ el: '#app', store: store, render: function render(h) {
    return h(__WEBPACK_IMPORTED_MODULE_6__apps_Obj_Tree_vue__["default"]);
  } });
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'C:\\wamp\\www\\LIFE_PLAN\\resources\\assets\\js\\apps\\Obj-Tree.vue'");
