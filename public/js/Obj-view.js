...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__apps_Obj_View_vue__ = __webpack_require__(165);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("a7dacb20", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("template", { slot: "fst" }, [_vm._v("\n\t\t123\n\t")]),
      _vm._v(" "),
      _c("template", { slot: "scnd" }, [_vm._v("\n\t\t1111111\n\t")])
    ],
    2
  )
}
