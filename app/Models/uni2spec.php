...
class Uni2Spec extends Model{
    ...
    public  function getProgramsForSearch(){
		return  convertToAssArr ( $this->select('rec_id','uni_id','spec_id', 'priceYear', 'qtyYears', 'qtyBudgets', 'totalBall', 'faculty', 'programmName', 'formStudy')->get()->toArray() ,$this->primaryKey);
    }
